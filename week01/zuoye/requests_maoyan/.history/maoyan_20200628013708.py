...
messages[' film_name']=selector. xpath("//div[ aclass=' movie-hover-info']/div/span[@ class=' name ']/text()")
print(messages)
...
# for ttitle in bs_info.find_all()('div',arrts={'calss':'channel-detail.movie-item-title'}):
#     for tname in ttitle.find_all('a',arrts={'class': 'name'}):
#         print (tname.get)
