...
film_name=selector. xpath("//div[ aclass=' movie-hover-info']/div/span [@ class=' name']/text()")
film_time=selector. xpath("//div[ aclass=' movie-hover-info']//div[4]/text()")
film_type=selector. xpath("//div[ aclass=' movie-hover-info']//div[2]/text()")
# movies['name']=selector.xpath('//*[@class="container"]/div/div[2]/div[2]/dl/dd[1]/div[2]')
# for moviesname in movies:
print(film_name)